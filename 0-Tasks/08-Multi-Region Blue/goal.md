...
```mermaid
flowchart LR
	Commit[Git commit: app.py / Dockerfile] --> Source[CodeCommit]
	Source --> Build[CodeBuild]
	Build --> ECR[Amazon ECR]
	ECR --> Deploy1[CodeDeploy us-east-1]
	ECR --> Deploy2[CodeDeploy eu-west-1]
	Deploy1 --> Primary[Primary ALB + blue/green ASG]
	Deploy2 --> Secondary[Secondary ALB + blue/green ASG]
	Primary --> DNS[Route 53 failover]
	Secondary --> DNS
```
